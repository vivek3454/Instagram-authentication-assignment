        ...
        <section className="w-full h-screen flex justify-center items-center">
            <div className="border-2 rounded p-8 w-96">
                <form action="" onSubmit={handleFormSubmit}>
                    <h2 className="text-gray-900 text-3xl font-bold text-center mb-5">Instagram Login</h2>
                    <div className="relative mb-4">
                        <label htmlFor="username" className='font-semibold'>username</label>
                        <input type="text" onChange={handleOnChange} value={userInfo.username} placeholder='username' autoComplete='false' id="username" name="username" className="w-full mt-1 bg-white rounded border border-gray-300 focus:border-blue-500 focus:ring-2 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                    </div>
                    <div className="relative mb-4">
                ...
                <p className="text-gray-500 mt-3 text-center text-sm">Forgot Password? <Link to={'/signup'} className="text-blue-600 ml-3" >Sign Up</Link></p>
